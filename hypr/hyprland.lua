...
-- Older laptop's panel; matched by description since it enumerates as eDP-2
-- there instead of eDP-1.
hl.monitor({ output = "desc:BOE 0x0B45", mode = "1920x1200@144", position = "0x0", scale = 1 })
